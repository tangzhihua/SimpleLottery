...
static CommandForSettingCocos2d *singletonInstance = nil;
...
@interface CommandForSettingCocos2d ()
// 这个命令只能执行一次
...
@implementation CommandForSettingCocos2d
...
+(id)commandForSettingCocos2d {
  if (nil == singletonInstance) {
    singletonInstance = [[CommandForSettingCocos2d alloc] init];
