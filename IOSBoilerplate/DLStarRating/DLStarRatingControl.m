...
- (void)setupView {
	...
	currentIdx = -1;
	star = [[UIImage imageNamed:@"star_gray.png"] retain];
	highlightedStar = [[UIImage imageNamed:@"star_orange.png"] retain];
  
	for (int i=0; i<numberOfStars; i++) {
		DLStarView *starView = [[DLStarView alloc] initWithDefault:self.star highlighted:self.highlightedStar position:i allowFractions:isFractionalRatingEnabled];
