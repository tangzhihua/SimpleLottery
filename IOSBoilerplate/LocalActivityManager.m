...
static const NSString *const TAG = @"<LocalActivityManager>";

@interface LocalActivityManager ()
...
@implementation LocalActivityManager

static LocalActivityManager *singletonInstance = nil;
